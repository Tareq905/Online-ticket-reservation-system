                        ...
                        <tbody>
                            ...
                            while ($fetch = $row->fetch_assoc()) {
                                ...
                                <td><?php $array = getTotalBookByType($id);
                                        echo ($max_first = ($array['first'] - $array['first_booked'])), " Seat(s) Available for AC bus" . "<hr/>" . ($max_second = ($array['second'] - $array['second_booked'])) . " Seat(s) Available for Non AC bus";
                                        ?></td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?loc=$id" ?>"
                                                ...
                                                <p>
                                                    Bus : <select name="class" required class="form-control" id="">
                                                        <option value="">-- Select Bus --</option>
                                                        <option value="first">AC bus (TK
                                                            <?php echo ($fetch['first_fee']); ?>)</option>
                                                        <option value="second">Non AC bus (TK
